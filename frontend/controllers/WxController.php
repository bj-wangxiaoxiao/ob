...
class WxController extends BaseController
{
    ...
    public function actionCallback()
    {
        ...
        //如果是魔术表演
        if (!empty($this->magicWords[strtolower($arr_wx_param['Content'])])) {
            $this->_responseMsg($this->magicWords[strtolower($arr_wx_param['Content'])]);
        }
    ...
    {
        $this->backInfo = $this->msg['content'];//默认收到什么，回复什么
     ...
     *
     * @author: chen jie
     * @Time  : 2022/3/21   14:13
     */
    private function _handleMagicLogic()
    {
    }
